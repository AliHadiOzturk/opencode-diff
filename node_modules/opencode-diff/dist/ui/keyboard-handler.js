...
export class KeyboardHandler extends EventEmitter {
     ...
     */
    getKeybindingsByContext(context) {
     ...
     */
    organizeKeybindingsIntoSections() {
        const sections = [
            {
                title: 'Line Actions',
                bindings: this.getKeybindingsByContext('action').filter(b => b.action === 'acceptLine' || b.action === 'rejectLine'),
            },
            {
                title: 'Hunk Actions',
                bindings: this.getKeybindingsByContext('action').filter(b => b.action === 'acceptHunk' || b.action === 'rejectHunk'),
            },
            {
                title: 'File Actions',
            ...
            {
                title: 'Navigation',
                bindings: this.getKeybindingsByContext('navigation').filter(b => b.key.length === 1 || b.key === 'ArrowUp' || b.key === 'ArrowDown'),
            },
            {
                title: 'Global',
